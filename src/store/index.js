...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    SET_SELECTION_2(state, selection2) {
      state.selectedLetter2 = selection2
    },
    SET_SELECTION_3(state, selection3) {
      state.selectedLetter3 = selection3
    },
    SET_SELECTION_4(state, selection4) {
      state.selectedLetter4 = selection4
    },
    SET_SELECTION_5(state, selection5) {
      state.selectedLetter5 = selection5
    },
    SET_GUESSED_WORDS(state, guessedWords){
      state.guessedWords = guessedWords
    },
    SET_CORRECT_WORDS(state, correctWords){
